...
- Multi Agent Stock Trader (https://github.com/jualam/Multi_Agent_Stock_Trader) - A CrewAI-based stock research project where AI agents find trending companies, analyze them, and generate a final investment decision report.

- Healthcare RAG LLM (https://github.com/jualam/healthcare-RAG-LLM) - A healthcare RAG research project focused on medical transcription data, privacy, and PII-aware response generation.
